...
def get_connection():
    conn = psycopg2.connect(
        host="localhost", # changed to db from localhost to connect to "db" in the container
        port=5434, # changed to port 5432 for use in the container, postgres running on 5432 there
